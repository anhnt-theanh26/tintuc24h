...
SECRET_KEY = 'django-insecure-0&4q!10th1gs5=med8)o^kuqjsvl%4+b*1ptwhk4r4@q_$b52='
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'news.my_context.items_sidebar_price_coin',
                'news.my_context.items_sidebar_price_gold',
            ],
        },
    },
]
